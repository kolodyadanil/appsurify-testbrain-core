...
def get_schema_view(info=None, url=None, schemes=None, patterns=None, urlconf=None, public=False, validators=None,
    ...
    class SchemaView(APIView):
        ...
        def get(self, request, version='', format=None):
            ...
            schema = generator.get_schema(request, self.schemes, self.public)
            if schema is None:
