...
class TestRemote(TestBase):
    ...
    def test_uncommon_branch_names(self):
        stderr_lines = fixture('uncommon_branch_prefix_stderr').decode('utf-8').splitlines()
        fetch_lines = fixture('uncommon_branch_prefix_FETCH_HEAD').decode('utf-8').splitlines()
