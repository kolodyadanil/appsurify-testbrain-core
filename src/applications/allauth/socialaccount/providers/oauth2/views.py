...
from applications.allauth.exceptions import ImmediateHttpResponse
from applications.allauth.socialaccount import providers
from applications.allauth.socialaccount.helpers import (
    complete_social_login,
    render_authentication_error,
)
from applications.allauth.socialaccount.models import SocialLogin, SocialToken
from applications.allauth.socialaccount.providers.base import ProviderException
from applications.allauth.socialaccount.providers.oauth2.client import (
    OAuth2Client,
    OAuth2Error,
)
from applications.allauth.utils import build_absolute_uri, get_request_param
...
class OAuth2CallbackView(OAuth2View):
    def dispatch(self, request):
        ...
        if host and host != request.META['HTTP_HOST']:
            ...
            redirect_url = '{protocol}{host}{uri}?{query}'.format(protocol=protocol, host=host, uri=uri, query=query)
