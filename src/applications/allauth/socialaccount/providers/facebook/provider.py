...
from applications.allauth.socialaccount.app_settings import QUERY_EMAIL
from applications.allauth.socialaccount.providers.base import (
    AuthAction,
    AuthProcess,
    ProviderAccount,
)
from applications.allauth.socialaccount.providers.oauth2.provider import OAuth2Provider
from applications.allauth.utils import import_callable
...
class FacebookProvider(OAuth2Provider):
    ...
    def get_login_url(self, request, **kwargs):
        ...
        if method == 'js_sdk':
            ...
            js = "applications.allauth.facebook.login(%s, %s, %s)" % (next, action, process)
