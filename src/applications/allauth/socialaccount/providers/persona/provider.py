...
from applications.allauth.socialaccount.providers.base import Provider, ProviderAccount
...
class PersonaProvider(Provider):
    ...
    def get_login_url(self, request, **kwargs):
        ...
        return 'javascript:applications.allauth.persona.login(%s, %s)' % (next_url, process)
