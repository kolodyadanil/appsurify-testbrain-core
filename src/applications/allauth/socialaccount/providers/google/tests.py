...
from applications.allauth.account.models import EmailAddress, EmailConfirmation
from applications.allauth.account.signals import user_signed_up
...
from applications.allauth.tests import MockedResponse, TestCase, patch
...
class GoogleTests(OAuth2TestsMixin, TestCase):
    ...
    def test_google_compelete_login_401(self):
        from applications.allauth.socialaccount.providers.google.views import GoogleOAuth2Adapter
        ...
        with patch(
                'applications.allauth.socialaccount.providers.google.views'
