...
from applications.allauth.account.adapter import get_adapter as get_account_adapter
from applications.allauth.account.utils import complete_signup, perform_login, user_username
