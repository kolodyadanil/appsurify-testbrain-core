...
import applications.allauth.app_settings
from applications.allauth.account.models import EmailAddress
from applications.allauth.account.utils import get_next_redirect_url, setup_user_email
...
class SocialAccount(models.Model):
    user = models.ForeignKey(applications.allauth.app_settings.USER_MODEL,
