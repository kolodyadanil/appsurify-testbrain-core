...
class AppSettings(object):
    ...
    class EmailVerificationMethod:
        # After signing up, keep the user account inactive until the email address is verified
        MANDATORY = 'mandatory'
    ...
    def DEFAULT_HTTP_PROTOCOL(self):
        return self._setting("DEFAULT_HTTP_PROTOCOL", "https").lower()
    ...
    def SIGNUP_IS_OPEN(self):
        ...
        """
        return self._setting('SIGNUP_IS_OPEN', True)
    ...
    @property
    def INVITE_CONFIRMATION_AUTHENTICATED_REDIRECT_URL(self):
        """
        The URL to redirect to after a successful invite confirmation, in
        case of an authenticated user
        """
        return self._setting("INVITE_CONFIRMATION_AUTHENTICATED_REDIRECT_URL", None)

    @property
    def INVITE_CONFIRMATION_ANONYMOUS_REDIRECT_URL(self):
        """
        The URL to redirect to after a successful invite confirmation, in
        case of an anonymous user
        """
        return self._setting("INVITE_CONFIRMATION_ANONYMOUS_REDIRECT_URL", None)
    ...
    def PASSWORD_CHANGE_REDIRECT_URL(self):
        ...
        """
        from django.conf import settings
        return self._setting('PASSWORD_CHANGE_REDIRECT_URL', None)
    ...
    @property
    def ADAPTER(self):
        return self._setting('ADAPTER', 'applications.allauth.account.adapter.DefaultAccountAdapter')
    ...
    @property
    def LOGIN_ON_SIGNUP(self):
        """
        Automatically log the user in once they success signup form
        """
        return self._setting('LOGIN_ON_SIGNUP', False)
    ...
    def USERNAME_VALIDATORS(self):
        ...
        from applications.allauth.utils import import_attribute
        from applications.allauth.utils import get_user_model
