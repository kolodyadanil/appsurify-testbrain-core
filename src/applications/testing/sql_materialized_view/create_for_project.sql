...
WITH test_execution_time AS (
    SELECT testing_testrunresult.test_run_id,
...
SELECT test_execution_time.test_run_id,
    test_statistic.tests_count,
    test_statistic.passed_tests_count,
    test_statistic.skipped_tests_count,
    test_statistic.failed_tests_count,
    test_statistic.broken_tests_count,
    test_statistic.not_run_tests_count,
    test_execution_time.execution_time
FROM test_execution_time
LEFT JOIN test_statistic ON test_execution_time.test_run_id = test_statistic.test_run_id;
