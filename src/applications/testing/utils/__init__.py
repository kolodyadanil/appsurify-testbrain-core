...
def create_date_list(queryset):
    ...
    # for index in xrange((max_date-min_date).days + 2):
...
def test_run_result_attachment_directory(instance, filename):

    return ''


def defect_attachment_directory(instance, filename):
